...
BASE_DIR = Path("/Users/ag/Downloads/0414_CA_Exams/MASTRANGELO_ANTHONY")
...
.header-right { font-size: 11pt; font-weight: bold; color: #2980b9; font-style: italic; }
...
.section-title {
    ...
    color: #fff; text-transform: uppercase; background-color: #2980b9;
...
.subsection-title {
    ...
    color: #1a5276; border-left: 4px solid #2980b9; padding-left: 10px;
...
th {
    background-color: #2980b9; color: #fff; font-weight: bold;
...
.bullet-item::before { content: "•"; position: absolute; left: -12px; color: #2980b9; font-weight: bold; }
...
def generate_pdf(md_path, pdf_path, title, header_left="Abstractor Notes/Chain"):
...
def main():
    ...
    print("=" * 60)
    generate_pdf(
        md_path=BASE_DIR / "RAW_Abstractor_Notes_Mastrangelo.md",
        pdf_path=BASE_DIR / "RAW_Abstractor_Notes_Mastrangelo.pdf",
        title="Abstractor Notes — MASTRANGELO",
    ...
    print("=" * 60)
    generate_pdf(
        md_path=BASE_DIR / "RAW_Two_Owner_Search_Mastrangelo.md",
        pdf_path=BASE_DIR / "Title_Exam_Mastrangelo.pdf",
        title="RAW Title Examination — MASTRANGELO",
